...
.method private isApkSuitableForAndroidPOrAbove(Ljava/lang/String;)Z
    ...
    invoke-static {v2, p1}, Lcom/xiaomi/analytics/internal/util/ALog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p1, v0}, Lcom/xiaomi/analytics/internal/Version;-><init>(Ljava/lang/String;)V

    new-instance v0, Lcom/xiaomi/analytics/internal/Version;

    const-string v2, "2.7.3"

    invoke-direct {v0, v2}, Lcom/xiaomi/analytics/internal/Version;-><init>(Ljava/lang/String;)V

    invoke-virtual {p1, v0}, Lcom/xiaomi/analytics/internal/Version;->compareTo(Lcom/xiaomi/analytics/internal/Version;)I
...
.method private loadAssetAnalytics()Lcom/xiaomi/analytics/internal/v1/AnalyticsInterface;
    ...
    invoke-static {v4, v5, v6}, Lcom/xiaomi/analytics/internal/util/AssetUtils;->extractAssetFile(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1}, Lcom/xiaomi/analytics/internal/SdkManager;->isApkSuitableForAndroidPOrAbove(Ljava/lang/String;)Z
    ...
    invoke-static {v1, v2, v3}, Lcom/xiaomi/analytics/internal/util/ApkTools;->extractSo(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v1, Lcom/xiaomi/analytics/internal/v1/DexAnalytics;
    ...
    invoke-direct {v1, v2, v3, v4}, Lcom/xiaomi/analytics/internal/v1/DexAnalytics;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private loadLocalAnalytics()Lcom/xiaomi/analytics/internal/v1/AnalyticsInterface;
    ...
    invoke-direct {v2, v3, v1, v4}, Lcom/xiaomi/analytics/internal/v1/DexAnalytics;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private notifyAnalyticsReady(Lcom/xiaomi/analytics/internal/v1/AnalyticsInterface;)V
    ...
    const-string v1, "Analytics module loaded, version is "
    ...
    invoke-static {p1, v0}, Lcom/xiaomi/analytics/internal/util/ALog;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setPolicyConfiguration(Lcom/xiaomi/analytics/PolicyConfiguration;)V
    ...
    invoke-virtual {v0, p1}, Lcom/xiaomi/analytics/PolicyConfiguration;->apply(Lcom/xiaomi/analytics/internal/v1/AnalyticsInterface;)V
