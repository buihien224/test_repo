...
.method private static decodeMetaBlockLength(Lorg/brotli/dec/BitReader;Lorg/brotli/dec/State;)V
    ...
    const-string p1, "Exuberant nibble"
    ...
    :cond_8
    :goto_4
    iget v6, p1, Lorg/brotli/dec/State;->metaBlockLength:I
...
.method static decompress(Lorg/brotli/dec/State;)V
    ...
    :cond_0
    :goto_0
    iget-object v4, p0, Lorg/brotli/dec/State;->runningState:Lorg/brotli/dec/RunningState;

    sget-object v5, Lorg/brotli/dec/RunningState;->FINISHED:Lorg/brotli/dec/RunningState;

    if-eq v4, v5, :cond_1c

    sget-object v4, Lorg/brotli/dec/Decode$1;->$SwitchMap$org$brotli$dec$RunningState:[I

    iget-object v5, p0, Lorg/brotli/dec/State;->runningState:Lorg/brotli/dec/RunningState;

    invoke-virtual {v5}, Lorg/brotli/dec/RunningState;->ordinal()I
    ...
    iget-object p0, p0, Lorg/brotli/dec/State;->runningState:Lorg/brotli/dec/RunningState;
    ...
    invoke-direct {v0, p0}, Lorg/brotli/dec/BrotliRuntimeException;-><init>(Ljava/lang/String;)V

    throw v0

    :pswitch_0
    invoke-static {p0}, Lorg/brotli/dec/Decode;->writeRingBuffer(Lorg/brotli/dec/State;)Z
    ...
    :cond_1
    iget-object v4, p0, Lorg/brotli/dec/State;->nextRunningState:Lorg/brotli/dec/RunningState;

    iput-object v4, p0, Lorg/brotli/dec/State;->runningState:Lorg/brotli/dec/RunningState;

    goto :goto_0

    :pswitch_1
    invoke-static {p0}, Lorg/brotli/dec/Decode;->copyUncompressedData(Lorg/brotli/dec/State;)V
    ...
    iput v4, p0, Lorg/brotli/dec/State;->metaBlockLength:I

    goto :goto_1

    :cond_2
    sget-object v4, Lorg/brotli/dec/RunningState;->BLOCK_START:Lorg/brotli/dec/RunningState;
    ...
    iget v5, p0, Lorg/brotli/dec/State;->copyDst:I

    iget v6, p0, Lorg/brotli/dec/State;->ringBufferSize:I

    sub-int/2addr v5, v6

    invoke-static {v3, v4, v3, v10, v5}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    sget-object v4, Lorg/brotli/dec/RunningState;->MAIN_LOOP:Lorg/brotli/dec/RunningState;
    ...
    iget v5, p0, Lorg/brotli/dec/State;->copyLength:I

    aget v4, v4, v5

    iget v5, p0, Lorg/brotli/dec/State;->distance:I

    iget v6, p0, Lorg/brotli/dec/State;->maxDistance:I

    sub-int/2addr v5, v6

    sub-int/2addr v5, v2

    sget-object v6, Lorg/brotli/dec/Dictionary;->SIZE_BITS_BY_LENGTH:[I

    iget v7, p0, Lorg/brotli/dec/State;->copyLength:I
    ...
    iget v6, p0, Lorg/brotli/dec/State;->copyDst:I

    invoke-static {}, Lorg/brotli/dec/Dictionary;->getData()[B

    move-result-object v8

    iget v9, p0, Lorg/brotli/dec/State;->copyLength:I
    ...
    iput v5, p0, Lorg/brotli/dec/State;->copyDst:I
    ...
    iput v5, p0, Lorg/brotli/dec/State;->metaBlockLength:I

    iget v4, p0, Lorg/brotli/dec/State;->copyDst:I

    iget v5, p0, Lorg/brotli/dec/State;->ringBufferSize:I

    if-lt v4, v5, :cond_3

    sget-object v4, Lorg/brotli/dec/RunningState;->COPY_WRAP_BUFFER:Lorg/brotli/dec/RunningState;

    iput-object v4, p0, Lorg/brotli/dec/State;->nextRunningState:Lorg/brotli/dec/RunningState;

    iget v4, p0, Lorg/brotli/dec/State;->ringBufferSize:I

    iput v4, p0, Lorg/brotli/dec/State;->bytesToWrite:I

    iput v10, p0, Lorg/brotli/dec/State;->bytesWritten:I

    sget-object v4, Lorg/brotli/dec/RunningState;->WRITE:Lorg/brotli/dec/RunningState;
    ...
    const-string v0, "Invalid backward reference"
    ...
    :pswitch_5
    invoke-static {p0}, Lorg/brotli/dec/Decode;->readMetablockHuffmanCodesAndContextMaps(Lorg/brotli/dec/State;)V
    ...
    iget-object v4, p0, Lorg/brotli/dec/State;->blockLength:[I

    aget v4, v4, v2

    if-nez v4, :cond_7

    invoke-static {p0}, Lorg/brotli/dec/Decode;->decodeCommandBlockSwitch(Lorg/brotli/dec/State;)V
    ...
    iget-object v4, p0, Lorg/brotli/dec/State;->hGroup1:Lorg/brotli/dec/HuffmanTreeGroup;

    iget-object v4, v4, Lorg/brotli/dec/HuffmanTreeGroup;->codes:[I

    iget v7, p0, Lorg/brotli/dec/State;->treeCommandOffset:I

    invoke-static {v4, v7, v0}, Lorg/brotli/dec/Decode;->readSymbol([IILorg/brotli/dec/BitReader;)I

    move-result v4

    ushr-int/lit8 v7, v4, 0x6

    iput v10, p0, Lorg/brotli/dec/State;->distanceCode:I
    ...
    iput v8, p0, Lorg/brotli/dec/State;->distanceCode:I

    :cond_8
    sget-object v8, Lorg/brotli/dec/Prefix;->INSERT_RANGE_LUT:[I
    ...
    sget-object v9, Lorg/brotli/dec/Prefix;->COPY_RANGE_LUT:[I
    ...
    sget-object v9, Lorg/brotli/dec/Prefix;->INSERT_LENGTH_N_BITS:[I
    ...
    iput v4, p0, Lorg/brotli/dec/State;->insertLength:I

    sget-object v4, Lorg/brotli/dec/Prefix;->COPY_LENGTH_OFFSET:[I

    aget v4, v4, v7

    sget-object v8, Lorg/brotli/dec/Prefix;->COPY_LENGTH_N_BITS:[I

    aget v7, v8, v7

    invoke-static {v0, v7}, Lorg/brotli/dec/BitReader;->readBits(Lorg/brotli/dec/BitReader;I)I

    move-result v7

    add-int/2addr v4, v7

    iput v4, p0, Lorg/brotli/dec/State;->copyLength:I

    iput v10, p0, Lorg/brotli/dec/State;->j:I

    sget-object v4, Lorg/brotli/dec/RunningState;->INSERT_LOOP:Lorg/brotli/dec/RunningState;

    iput-object v4, p0, Lorg/brotli/dec/State;->runningState:Lorg/brotli/dec/RunningState;

    :pswitch_7
    iget-boolean v4, p0, Lorg/brotli/dec/State;->trivialLiteralContext:Z

    if-eqz v4, :cond_b

    :cond_9
    iget v4, p0, Lorg/brotli/dec/State;->j:I

    iget v7, p0, Lorg/brotli/dec/State;->insertLength:I
    ...
    invoke-static {p0}, Lorg/brotli/dec/Decode;->decodeLiteralBlockSwitch(Lorg/brotli/dec/State;)V
    ...
    iget-object v7, p0, Lorg/brotli/dec/State;->hGroup0:Lorg/brotli/dec/HuffmanTreeGroup;

    iget-object v7, v7, Lorg/brotli/dec/HuffmanTreeGroup;->codes:[I

    iget v8, p0, Lorg/brotli/dec/State;->literalTree:I

    invoke-static {v7, v8, v0}, Lorg/brotli/dec/Decode;->readSymbol([IILorg/brotli/dec/BitReader;)I
    ...
    iput v4, p0, Lorg/brotli/dec/State;->j:I

    iget v4, p0, Lorg/brotli/dec/State;->pos:I

    add-int/lit8 v7, v4, 0x1

    iput v7, p0, Lorg/brotli/dec/State;->pos:I
    ...
    iget v7, p0, Lorg/brotli/dec/State;->pos:I
    ...
    :goto_2
    iget v8, p0, Lorg/brotli/dec/State;->j:I

    iget v9, p0, Lorg/brotli/dec/State;->insertLength:I

    if-ge v8, v9, :cond_e

    invoke-static {v0}, Lorg/brotli/dec/BitReader;->readMoreInput(Lorg/brotli/dec/BitReader;)V

    iget-object v8, p0, Lorg/brotli/dec/State;->blockLength:[I
    ...
    iget v9, p0, Lorg/brotli/dec/State;->contextMapSlice:I

    sget-object v11, Lorg/brotli/dec/Context;->LOOKUP:[I

    iget v12, p0, Lorg/brotli/dec/State;->contextLookupOffset1:I

    add-int/2addr v12, v7

    aget v11, v11, v12

    sget-object v12, Lorg/brotli/dec/Context;->LOOKUP:[I

    iget v13, p0, Lorg/brotli/dec/State;->contextLookupOffset2:I
    ...
    iget-object v8, p0, Lorg/brotli/dec/State;->hGroup0:Lorg/brotli/dec/HuffmanTreeGroup;

    iget-object v8, v8, Lorg/brotli/dec/HuffmanTreeGroup;->codes:[I
    ...
    invoke-static {v8, v4, v0}, Lorg/brotli/dec/Decode;->readSymbol([IILorg/brotli/dec/BitReader;)I

    move-result v4

    iget v8, p0, Lorg/brotli/dec/State;->pos:I
    ...
    iput v8, p0, Lorg/brotli/dec/State;->j:I

    iget v8, p0, Lorg/brotli/dec/State;->pos:I

    add-int/lit8 v9, v8, 0x1

    iput v9, p0, Lorg/brotli/dec/State;->pos:I
    ...
    :cond_10
    iget v4, p0, Lorg/brotli/dec/State;->distanceCode:I
    ...
    invoke-static {p0}, Lorg/brotli/dec/Decode;->decodeDistanceBlockSwitch(Lorg/brotli/dec/State;)V
    ...
    iget-object v4, p0, Lorg/brotli/dec/State;->hGroup2:Lorg/brotli/dec/HuffmanTreeGroup;

    iget-object v4, v4, Lorg/brotli/dec/HuffmanTreeGroup;->codes:[I

    iget-object v8, p0, Lorg/brotli/dec/State;->hGroup2:Lorg/brotli/dec/HuffmanTreeGroup;

    iget-object v8, v8, Lorg/brotli/dec/HuffmanTreeGroup;->trees:[I

    iget-object v9, p0, Lorg/brotli/dec/State;->distContextMap:[B

    iget v11, p0, Lorg/brotli/dec/State;->distContextMapSlice:I

    iget v12, p0, Lorg/brotli/dec/State;->copyLength:I
    ...
    invoke-static {v4, v8, v0}, Lorg/brotli/dec/Decode;->readSymbol([IILorg/brotli/dec/BitReader;)I

    move-result v4

    iput v4, p0, Lorg/brotli/dec/State;->distanceCode:I
    ...
    iget v8, p0, Lorg/brotli/dec/State;->distancePostfixMask:I

    and-int/2addr v4, v8

    iget v8, p0, Lorg/brotli/dec/State;->distanceCode:I
    ...
    iget v9, p0, Lorg/brotli/dec/State;->distanceCode:I
    ...
    iget v5, p0, Lorg/brotli/dec/State;->numDirectDistanceCodes:I
    ...
    iput v5, p0, Lorg/brotli/dec/State;->distanceCode:I

    :cond_13
    iget v4, p0, Lorg/brotli/dec/State;->distanceCode:I

    iget-object v5, p0, Lorg/brotli/dec/State;->distRb:[I

    iget v6, p0, Lorg/brotli/dec/State;->distRbIdx:I

    invoke-static {v4, v5, v6}, Lorg/brotli/dec/Decode;->translateShortCodes(I[II)I

    move-result v4

    iput v4, p0, Lorg/brotli/dec/State;->distance:I
    ...
    iget v4, p0, Lorg/brotli/dec/State;->maxDistance:I
    ...
    iput v4, p0, Lorg/brotli/dec/State;->maxDistance:I
    ...
    iput v4, p0, Lorg/brotli/dec/State;->copyDst:I

    iget v4, p0, Lorg/brotli/dec/State;->distance:I

    iget v5, p0, Lorg/brotli/dec/State;->maxDistance:I

    if-le v4, v5, :cond_15

    sget-object v4, Lorg/brotli/dec/RunningState;->TRANSFORM:Lorg/brotli/dec/RunningState;
    ...
    iget-object v4, p0, Lorg/brotli/dec/State;->distRb:[I

    iget v5, p0, Lorg/brotli/dec/State;->distRbIdx:I

    and-int/2addr v5, v7

    iget v6, p0, Lorg/brotli/dec/State;->distance:I

    aput v6, v4, v5

    iget v4, p0, Lorg/brotli/dec/State;->distRbIdx:I

    add-int/2addr v4, v2

    iput v4, p0, Lorg/brotli/dec/State;->distRbIdx:I
    ...
    sget-object v4, Lorg/brotli/dec/RunningState;->COPY_LOOP:Lorg/brotli/dec/RunningState;
    ...
    invoke-static {p0}, Lorg/brotli/dec/Decode;->readMetablockInfo(Lorg/brotli/dec/State;)V
    ...
    const-string v0, "Invalid metablock length"
    ...
    :cond_1c
    iget-object v1, p0, Lorg/brotli/dec/State;->runningState:Lorg/brotli/dec/RunningState;

    sget-object v2, Lorg/brotli/dec/RunningState;->FINISHED:Lorg/brotli/dec/RunningState;
    ...
    invoke-static {p0}, Lorg/brotli/dec/BitReader;->checkHealth(Lorg/brotli/dec/BitReader;)V
