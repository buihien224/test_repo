...
.method private createBlurBackground()V
    ...
    invoke-virtual {p0}, Lmiuix/blurdrawable/widget/BlurBackgroundView;->getResources()Landroid/content/res/Resources;
...
.method public setBlurBackground(Z)Z
    ...
    const-string v4, "Blur creat fail e:"
    ...
    invoke-virtual {p0}, Lmiuix/blurdrawable/widget/BlurBackgroundView;->getVisibility()I

    move-result p1

    if-nez p1, :cond_2

    invoke-virtual {p0}, Lmiuix/blurdrawable/widget/BlurBackgroundView;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {p0, v1}, Lmiuix/blurdrawable/widget/BlurBackgroundView;->setVisibility(I)V

    iget-object p1, p0, Lmiuix/blurdrawable/widget/BlurBackgroundView;->mBlurForeground:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0, p1}, Lmiuix/blurdrawable/widget/BlurBackgroundView;->setForeground(Landroid/graphics/drawable/Drawable;)V

    iget-object p1, p0, Lmiuix/blurdrawable/widget/BlurBackgroundView;->mBlurBackground:Lcom/miui/blur/sdk/drawable/BlurDrawable;

    invoke-virtual {p0, p1}, Lmiuix/blurdrawable/widget/BlurBackgroundView;->setBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v0}, Lmiuix/blurdrawable/widget/BlurBackgroundView;->setForeground(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {p0, v0}, Lmiuix/blurdrawable/widget/BlurBackgroundView;->setBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1}, Lmiuix/blurdrawable/widget/BlurBackgroundView;->setVisibility(I)V
