...
.method public constructor <init>(Ljava/util/TimeZone;)V
    ...
    iget v2, p0, Lmiuix/pickerwidget/date/Calendar;->julianError:I
    ...
    iput v1, p0, Lmiuix/pickerwidget/date/Calendar;->julianSkew:I
...
.method private appendValue(Ljava/lang/StringBuilder;Lmiuix/pickerwidget/date/CalendarFormatSymbols;CII)V
    ...
    invoke-direct {p0, p1, v8, v8}, Lmiuix/pickerwidget/date/Calendar;->appendNumericTimeZone(Ljava/lang/StringBuilder;ZZ)V
    ...
    invoke-direct {p0, p1, v2, v8}, Lmiuix/pickerwidget/date/Calendar;->appendNumericTimeZone(Ljava/lang/StringBuilder;ZZ)V

    goto/16 :goto_1

    :cond_5
    invoke-direct {p0, p1, v2, v2}, Lmiuix/pickerwidget/date/Calendar;->appendNumericTimeZone(Ljava/lang/StringBuilder;ZZ)V
...
.method private computeChineseDate(J)V
    ...
    :cond_3
    invoke-static {v2, p1}, Lmiuix/pickerwidget/date/Calendar;->daysInChineseMonth(II)I
...
.method public add(II)Lmiuix/pickerwidget/date/Calendar;
    ...
    :goto_0
    iget-wide v2, p0, Lmiuix/pickerwidget/date/Calendar;->mMillisecond:J
    ...
    :cond_1e
    invoke-virtual {p0, v9, p1}, Lmiuix/pickerwidget/date/Calendar;->add(II)Lmiuix/pickerwidget/date/Calendar;
...
.method public set(IIIIIII)Lmiuix/pickerwidget/date/Calendar;
    ...
    invoke-static {v0, p2}, Lmiuix/pickerwidget/date/Calendar;->daysInMonth(ZI)I
...
.method public setGregorianChange(J)V
    ...
    iget v3, p0, Lmiuix/pickerwidget/date/Calendar;->julianError:I
    ...
    iput v2, p0, Lmiuix/pickerwidget/date/Calendar;->julianSkew:I
