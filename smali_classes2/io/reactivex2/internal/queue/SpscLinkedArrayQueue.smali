...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        ">",
        "Ljava/lang/Object;",
        "Lio/reactivex2/internal/fuseable/SimplePlainQueue<",
        "TT;>;"
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex2/internal/queue/SpscLinkedArrayQueue;->HAS_NEXT:Ljava/lang/Object;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lio/reactivex2/internal/queue/SpscLinkedArrayQueue;->consumerIndex:Ljava/util/concurrent/atomic/AtomicLong;
...
.method private adjustLookAheadStep(I)V
    ...
    iput p1, p0, Lio/reactivex2/internal/queue/SpscLinkedArrayQueue;->producerLookAheadStep:I
...
.method private lpConsumerIndex()J
    ...
    iget-object v0, p0, Lio/reactivex2/internal/queue/SpscLinkedArrayQueue;->consumerIndex:Ljava/util/concurrent/atomic/AtomicLong;
...
.method private lpProducerIndex()J
    ...
    iget-object v0, p0, Lio/reactivex2/internal/queue/SpscLinkedArrayQueue;->producerIndex:Ljava/util/concurrent/atomic/AtomicLong;
...
.method private lvNextBufferAndUnlink(Ljava/util/concurrent/atomic/AtomicReferenceArray;I)Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    invoke-static {p1, p2}, Lio/reactivex2/internal/queue/SpscLinkedArrayQueue;->lvElement(Ljava/util/concurrent/atomic/AtomicReferenceArray;I)Ljava/lang/Object;
    ...
    invoke-static {p1, p2, v1}, Lio/reactivex2/internal/queue/SpscLinkedArrayQueue;->soElement(Ljava/util/concurrent/atomic/AtomicReferenceArray;ILjava/lang/Object;)V
...
.method private soNext(Ljava/util/concurrent/atomic/AtomicReferenceArray;Ljava/util/concurrent/atomic/AtomicReferenceArray;)V
    ...
    invoke-static {v0}, Lio/reactivex2/internal/queue/SpscLinkedArrayQueue;->calcDirectOffset(I)I

    move-result v0

    invoke-static {p1, v0, p2}, Lio/reactivex2/internal/queue/SpscLinkedArrayQueue;->soElement(Ljava/util/concurrent/atomic/AtomicReferenceArray;ILjava/lang/Object;)V
...
.method public clear()V
    ...
    invoke-virtual {p0}, Lio/reactivex2/internal/queue/SpscLinkedArrayQueue;->isEmpty()Z
...
.method public isEmpty()Z
    ...
    invoke-direct {p0}, Lio/reactivex2/internal/queue/SpscLinkedArrayQueue;->lvConsumerIndex()J
...
.method public poll()Ljava/lang/Object;
    ...
    invoke-direct {p0, v0, v1, v2, v3}, Lio/reactivex2/internal/queue/SpscLinkedArrayQueue;->newBufferPoll(Ljava/util/concurrent/atomic/AtomicReferenceArray;JI)Ljava/lang/Object;
