...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "Ljava/lang/Enum<",
        "Lio/reactivex2/internal/disposables/DisposableHelper;",
        ">;",
...
# static fields
.field private static final synthetic $VALUES:[Lio/reactivex2/internal/disposables/DisposableHelper;

.field public static final enum DISPOSED:Lio/reactivex2/internal/disposables/DisposableHelper;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2}, Lio/reactivex2/internal/disposables/DisposableHelper;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lio/reactivex2/internal/disposables/DisposableHelper;->DISPOSED:Lio/reactivex2/internal/disposables/DisposableHelper;
    ...
    sput-object v0, Lio/reactivex2/internal/disposables/DisposableHelper;->$VALUES:[Lio/reactivex2/internal/disposables/DisposableHelper;
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex2/disposables/Disposable;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static reportDisposableSet()V
    ...
    invoke-direct {v0, v1}, Lio/reactivex2/exceptions/ProtocolViolationException;-><init>(Ljava/lang/String;)V
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex2/disposables/Disposable;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex2/disposables/Disposable;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object p1, Lio/reactivex2/internal/disposables/DisposableHelper;->DISPOSED:Lio/reactivex2/internal/disposables/DisposableHelper;
...
.method public static trySet(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex2/disposables/Disposable;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static validate(Lio/reactivex2/disposables/Disposable;Lio/reactivex2/disposables/Disposable;)Z
    .locals 1
...
.method public static valueOf(Ljava/lang/String;)Lio/reactivex2/internal/disposables/DisposableHelper;
    ...
    check-cast p0, Lio/reactivex2/internal/disposables/DisposableHelper;
...
.method public static values()[Lio/reactivex2/internal/disposables/DisposableHelper;
    ...
    check-cast v0, [Lio/reactivex2/internal/disposables/DisposableHelper;
